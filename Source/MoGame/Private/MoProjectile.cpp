...
// Sets default values
AMOProjectile::AMOProjectile(const class FObjectInitializer& ObjectInitializer)
: Super(ObjectInitializer)
{
	...
	if (ProjectileCollision != nullptr)
	{
		...
		ProjectileCollision->OnComponentBeginOverlap.AddDynamic(this, &AMOProjectile::OnOverlapBegin);
...
void AMOProjectile::OnOverlapBegin(class UPrimitiveComponent* HitComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult & SweepResult)
{
