...
AMOHUD::AMOHUD(const FObjectInitializer& ObjectInitializer)
...
void AMOHUD::DrawActorsHealth()
{
	for (FConstPawnIterator Iterator = GetWorld()->GetPawnIterator(); Iterator; ++Iterator)
	{
		AMOCharacter* Character = Cast<AMOCharacter>(*Iterator);
...
void AMOHUD::DrawHealthBar(AMOCharacter* Character, float HealthPercentage, int32 BarHeight, int32 OffsetY) const
{
